...
<div class="page page--content-sidebar">
    ...
    <div class="page__main">
        ...
        <div class="page__main__inner">
            ...
            <div class="grid">
                ...
                <div class="column column--span-4 sidebar sidebar--left" id="SideBarPane" runat="server" containertype="G" containername="sphdhv" containersrc="container_block_white.ascx"></div>
