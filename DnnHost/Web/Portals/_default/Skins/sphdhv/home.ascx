        ...
        <div class="page__main__inner">
            ...
            <div class="grid">
                ...
                <div class="column column--span-4">
                    ...
                    <div class="block block--primary-light-blue">

                        <div id="spaarBovenPane" runat="server" containertype="G" containername="sphdhv" containersrc="container_block_title.ascx"></div>

                        <div class="dropdown">

                            <button class="dropdown__button js-dropdown" type="button">Wat doe ik bij?</button>

                            <dnn:MENU ID="dropdownNavSave" MenuStyle="navigation/nav-dropdown" NodeSelector="Sparen" IncludeHidden="true" runat="server"></dnn:MENU>
                ...
                <div class="column column--span-4">
                    ...
                    <div class="block block--primary-light-blue">
                        ...
                        <div class="dropdown">
                            ...
                            <dnn:MENU ID="dropdownNavReceive" MenuStyle="navigation/nav-dropdown" NodeSelector="Ontvangen" IncludeHidden="true" runat="server"></dnn:MENU>
                ...
                <div class="column column--span-4">
                    ...
                    <div class="block block--primary-light-blue">
                        ...
                        <div class="dropdown">
                            ...
                            <dnn:MENU ID="dropdownNavParticipants" MenuStyle="navigation/nav-dropdown" NodeSelector="Deelnemers" IncludeHidden="true" runat="server"></dnn:MENU>
            ...
            <div class="grid grid--last">
                ...
                <div class="column column--span-8 news=-pane" id="actueelPane" runat="server" containertype="G" containername="sphdhv" containersrc="container_block_white.ascx"></div>
