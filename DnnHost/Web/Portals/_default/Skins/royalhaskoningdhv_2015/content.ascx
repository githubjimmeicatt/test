    ...
    <div class="main">
        ...
        <div class="row">
            ...
            <div class="col nav">
                ...
                <dnn:MENU MenuStyle="menumobile" NodeSelector="CurrentChildren" runat="server"></dnn:MENU>

                <dnn:MENU MenuStyle="menu" NodeSelector="CurrentChildren" runat="server"></dnn:MENU>

            </div>

            <div class="col article last" id="contentPane" runat="server"></div>
