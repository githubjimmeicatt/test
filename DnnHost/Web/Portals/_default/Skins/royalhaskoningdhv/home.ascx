...
<div class="layout-container" id="main">

    <div class="layout-main">

        <div class="article" id="contentPane" runat="server"></div>

    </div>

    <div class="layout-aside" id="AsidePane" runat="server"></div>
...
<script>
    ...
    (function($, window, document) {
        ...
        function stickyFooter() {
            ...
            var wrapperHeight = $('#main').outerHeight();
            var footerHeight = $('#footer').outerHeight();
            var diff = windowHeight - wrapperHeight;
