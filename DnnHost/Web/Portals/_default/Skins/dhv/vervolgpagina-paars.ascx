...
<div id="container" class="vervolgskin paars">
    ...
    <div id="PaneContainer" class="cf">
        ...
        <div runat="server" id="LeftPane" class="LeftPane">
            ...
            <div class="module-container paars small menu">
        ...
        <div id="RightPanesContainer" class="cf">
            ...
            <div id="article-header">
                ...
                <dnn:BREADCRUMB runat="server" id="dnnBREADCRUMB"  CssClass="Breadcrumb" RootLevel="0" Separator="&nbsp;:&nbsp;" UseTitle="False" />
