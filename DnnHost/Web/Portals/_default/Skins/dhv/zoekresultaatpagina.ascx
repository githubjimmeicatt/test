...
<div id="container" class="vervolgskin zoekresultaatskin">
    ...
    <div id="PaneContainer" class="cf">
        ...
        <div runat="server" id="LeftPane" class="LeftPane">
            ...
            <div class="module-container blauw small search">
                <h3 class="cfn-thesansbold">Opnieuw zoeken</h3>
                <dnn:SEARCH runat="server" id="dnnSEARCH_again" showWeb="False" showSite="False" />
            </div>
