<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Preview.ascx.cs" Inherits="WI.Modules.WowChartv3.InnerControls.Preview" %>
...
<div id="module-<%=ModuleId %>" data-ng-controller="mainAppCtrl as ctrl" data-ng-init="ctrl.init()" data-ng-cloak="" data-cg-busy="{promise:ctrl.appPromise}" class="chart-module-container">
    <select data-ng-model="ctrl.selectedChart" data-ng-options="chart as 'Id: ' + chart.Id + ' ' + chart.Name for chart in ctrl.charts" data-ng-change="ctrl.onChartChange()" data-ng-if="ctrl.charts.length>1" style="display:initial;min-width:250px">
    </select>
