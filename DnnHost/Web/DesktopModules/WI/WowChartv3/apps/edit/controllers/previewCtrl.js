WowChartv3_previewCtrl.$inject = ['$rootScope', '$scope', 'chartService', 'utils', 'pageService', 'toastrService'];
function WowChartv3_previewCtrl($rootScope, $scope, chartService, utils, pageService, toastrService) {
    var self = this, data;
