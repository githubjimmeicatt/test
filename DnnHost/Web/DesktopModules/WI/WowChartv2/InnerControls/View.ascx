<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="WI.Modules.WowChartv2.InnerControls.View" %>
...
<asp:HyperLink ID="hlConfigChart" runat="server" Text="Configure Chart" CssClass="dnnSecondaryAction" Visible="false" />
