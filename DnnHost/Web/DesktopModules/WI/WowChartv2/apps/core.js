(function () {
    ...
    ngApp
        ...
        .directive("ngGoalChart", WowChartv2_ngGoalChart)
        .directive("ngHighChart", WowChartv2_ngHighChart)
        .directive("ngOrgChart", WowChartv2_ngOrgChart);

    try {
        ngApp.directive("fileModel", WowChartv2_fileModel);
    } catch (ex) { }

    try {
        ngApp.directive("ngTooltip", WowChartv2_ngTooltip);
    } catch (ex) { }

    try {
        ngApp.directive("ngTabs", WowChartv2_ngTabs);
    } catch (ex) { }
