...
<select name="site">
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='abu')]">
   <option value="abu" selected="selected">abu</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='allestelt_alles')]">
   <option value="allestelt_alles" selected="selected">allestelt_alles</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="allestelt_alles">allestelt_alles</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='allestelt_pagina')]">
   <option value="allestelt_pagina" selected="selected">allestelt_pagina</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="allestelt_pagina">allestelt_pagina</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='brein')]">
   <option value="brein" selected="selected">brein</option>
  </xsl:when>
  <xsl:otherwise>
 ...
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='focwa')]">
   <option value="focwa" selected="selected">focwa</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="focwa">focwa</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='forum_stefan')]">
   <option value="forum_stefan" selected="selected">forum_stefan</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="forum_stefan">forum_stefan</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='forum_test')]">
   <option value="forum_test" selected="selected">forum_test</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="forum_test">forum_test</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='icattintranet')]">
   <option value="icattintranet" selected="selected">icattintranet</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="icattintranet">icattintranet</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='icattprojecten')]">
   <option value="icattprojecten" selected="selected">icattprojecten</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="icattprojecten">icattprojecten</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='icattsite')]">
   <option value="icattsite" selected="selected">icattsite</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="icattsite">icattsite</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='nin_develop')]">
   <option value="nin_develop" selected="selected">nin_develop</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="nin_develop">nin_develop</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='nin_live')]">
   <option value="nin_live" selected="selected">nin_live</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="nin_live">nin_live</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='nin_test')]">
   <option value="nin_test" selected="selected">nin_test</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="nin_test">nin_test</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='thiememeulenhoff')]">
   <option value="thiememeulenhoff" selected="selected">thiememeulenhoff</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="thiememeulenhoff">thiememeulenhoff</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='uaf_develop')]">
   <option value="uaf_develop" selected="selected">uaf_develop</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="uaf_develop">uaf_develop</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='uaf_live')]">
   <option value="uaf_live" selected="selected">uaf_live</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="uaf_live">uaf_live</option>
  </xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='uaf_test')]">
   <option value="uaf_test" selected="selected">uaf_test</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="uaf_test">uaf_test</option>
  </xsl:otherwise>
 </xsl:choose>
</select>
