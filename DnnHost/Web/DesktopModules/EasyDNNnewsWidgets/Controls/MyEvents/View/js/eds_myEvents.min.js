...
(b.$visibleItemList.removeClass("edn__myEvents_itemsHidden"),b.$hiddenItemWrapper.removeClass("edn__myEvents_itemsHidden"))}};var p={websiteClientRoot:"/",portalId:0,moduleId:0,tabId:0,itemsPerPage:5,initialContentItemCount:0,masonry:!1,filterEventsBy:"currentAndUpcoming"};c.fn.edNewsMyEvents=function(f){f=c.extend({},p,f);return this.each(function(){var b=c(this);b.data("edNewsMyEvents")||b.data("edNewsMyEvents",new k(this,f))})}})(eds2_2,window);