...
allowInputToggle:!0}};r.prototype={};c.fn.eds_jq_DateRestrictionPayment_Edit_1_0_0=function(p){p=c.extend(!0,{},q,p);c.fn.eds_jq_DateRestrictionPayment_Edit_1_0_0.Validate=function(c){for(var d=0;d<q.validate.length;d++)if(q.validate[d][0]===c)return returnValidationMeta=q.validate[d][1](c),returnValidationMeta.success;return!1};return this.each(function(){c.data(this,"eds_jq_DateRestrictionPayment_Edit_1_0_0")||c.data(this,"eds_jq_DateRestrictionPayment_Edit_1_0_0",new r(this,p))})}})(eds3_5_jq,window);